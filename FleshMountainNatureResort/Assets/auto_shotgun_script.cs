...
public class auto_shotgun_script : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        animator.SetInteger("player_ammo", player.GetComponent<player_inventory>().return_shotgun_ammo());
    }
    ...
    {
        animator.SetBool("tryShot", false);
    }
    ...
    public void reload_script()
    {
        ...
        if (reload_amount > 0)
        {
            if (player_ammo >= 1)
            {
                ...
                ammo_in_magazine = ammo_in_magazine + 1;
                player.GetComponent<player_inventory>().reload_shotgun(1);
            }
        }
    }
